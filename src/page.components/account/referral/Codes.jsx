...
<div className="css-1vuvc25">
    <div >
        <div>
            <div>
                <div className="css-1f51ttt">
                    <input type="text" name="code" placeholder="Create new referral code"  />
                    <button className="css-vmbe4r button" type="submit" style={{marginRight: "4px"}}>Create</button>
                </div>
            </div>
        </div>
    </div>
...
<div className="css-1mwdm11">
    {/* <!-- <div id="rollbit-modal-popover-container">
        <div className="css-29gh6u" style="height: 33.1979px; max-height: 33.1979px; top: 517.708px; left: 349.589px;">
            <div className="css-1nrrr26">
                Copy
                <div className="css-97vfs4" style="left: 14.0938px;"></div>
            </div>
        </div>
    </div> --> */}
    <table className="css-wcq858">
        ...
        <tbody className="css-13107in">
            ...
            {/* <tr className="css-1k5q1yl">
                <td className="css-1nwtsan">
                    <div>{data?.code}</div>
                </td>
                ...
                <td className="css-rja9yq">
                    <div>
                        ...
                        {/if}
                        {#if !isCopied}
                            <button on:click={()=> copyTextToClipboard(data?.code)} className="css-3ile2c">
                                <svg width="20px" height="20px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" size="18" className="css-oluyn3">
...
<div className="css-57x4g4">
    ...
    <div color="text3" size="14" className="css-1ippc9u">No referral codes found</div>
</div>
{/if}
{/if} */}
    </>

...
const DiceControls = () => {
  ...
  return (
    <div className="w-70 h-full bg-gray-800 bg-opacity-50 p-4 rounded-tl-[18px] rounded-bl-[18px] space-y-5">
      ...
      <button 
        ...
        className={`w-full py-4 rounded-lg font-bold text-sm flex items-center justify-center transition-all ${
          gameState === 'rolling' 

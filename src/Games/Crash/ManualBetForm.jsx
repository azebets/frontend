    ...
    <div className="space-y-4">
      ...
      <div className="pt-2 space-y-2">
        ...
        {!userBet && nextRoundBet && (
          <button onClick={handleCancelNextRoundBet} className={`w-full py-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-sm font-medium flex items-center justify-center text-white`}>
            Cancel
          </button>
        )}
        ...
        {userBet && gameState.status === 'running' && (
          <button 
            className="w-full py-4 bg-blue-600 hover:bg-blue-500 rounded-lg text-sm font-bold transition-colors flex items-center justify-center"

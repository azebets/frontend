        ...
        <div className="flex">
          ...
          <div className="w-[200px] mr-6">
            <div className="sticky bg-[rgb(15,33,46)] p-2 rounded-2xl">
              <button 
                className={`w-full rounded-md text-left p-3 bg-[#071824] cursor-pointer ${
                  activeTab === 'overview' 
                    ? 'border-l-4 border-blue-600 text-white pl-3' 
          ...
          {/* Right side - Content with more content to demonstrate scrolling */}
          <div className="flex-1">
            ...
            <div className="w-full mt-8">
              ...
              <div className="w-full bg-[#213743] rounded-[0.5rem] p-2 mt-6">
                <img
                  src="/assets/affiliate-icons/stake-affiliate-overview-templates-en.avif"
                  alt="Stake Affiliate Overview Templates"

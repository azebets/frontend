...
export default function Original() {
    ...
    const Games = path === "slots" ? slotsGames : path === "live-casino" ? liveCasino : path === "game-shows" ? showGame : inHouseGames
  return (
    <div className="css-ojf8hg">
        <div className="css-1yx9de1">
            <div className="css-1y4bokc">
                <div className="css-1umk8r2">
                    ...
                    <input type="text" placeholder="Search originals" /></div>
                    <button className="css-ltx4sp" type="button">
                        <div className="css-xb95tu">Provider: <div className="css-18ifrrj">All</div>
                    </div>
                    <span style={{marginLeft: "auto"}}>
                        <svg width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg" size="7" color="#B1B6C6" className="css-1vsy0ig" style={{marginLeft: "6px"}}>
                ...
                <button className="css-ltx4sp" type="button">
                    <div className="css-xb95tu">Sort by: 
                        <div className="css-18ifrrj">Popular</div>
                    </div>
                    <span style={{marginLeft: "auto"}}>
                        <svg width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg" size="7" color="#B1B6C6" className="css-1vsy0ig" style={{marginLeft: "6px"}}>
                        <path d="M0.934258 -6.17707e-07L7.06574 -8.16755e-08C7.46509 -4.67634e-08 7.70329 0.445072 7.48177 0.77735L4.41602 5.37596C4.21811 5.67283 3.78189 5.67283 3.58397 5.37596L0.518233 0.777349C0.296715 0.445072 0.534911 -6.52619e-07 0.934258 -6.17707e-07Z" fill="currentColor"></path>
                ...
                {Games.map((game) => (
                    <div key={game.img}>
                        <div className="css-d6icxj">
                            <img className="css-nyormw" src={game.img} alt={game.name} />

...
export default function Index() {
    ...
    const [publicChat, setPublicChat] = React.useState([
        {profile: {username: "SWEETBONANZA🍭", profileImg: "https://rollbit.com/static/Icon%203%20(gold)-Cz9Y9AJt.png"}, text: "faken real"},
        {profile: {username: "SWEETBONANZA🍭", profileImg: "https://rollbit.com/static/Icon%203%20(gold)-Cz9Y9AJt.png"}, text: "faken real"},
        {profile: {username: "SWEETBONANZA🍭", profileImg: "https://rollbit.com/static/Icon%203%20(gold)-Cz9Y9AJt.png"}, text: "faken real"},
        {profile: {username: "SWEETBONANZA🍭", profileImg: "https://rollbit.com/static/Icon%203%20(gold)-Cz9Y9AJt.png"}, text: "faken real"},
        {profile: {username: "SWEETBONANZA🍭", profileImg: "https://rollbit.com/static/Icon%203%20(gold)-Cz9Y9AJt.png"}, text: "faken real"},
  ...
  return (
    <div class="css-1o06751" style={{paddingBottom: "0px", zIndex: 3, width:`${sideHasExpand}`"px"}}>
            ...
            <div  class="css-1q1bjed">
                ...
                <label style={{cursor: "text" margin: "0px"}}>
                    <div class="css-14c5l9t">
                        <div class="rollbit-chat-input rollbit-chat-input--multiLine" >
                            <div class="rollbit-chat-input__control">
                                <div class="rollbit-chat-input__highlighter" style={{position: "relative", boxSizing: "border-box", width: "100%", color: "transparent", overflow: "hidden", whiteSpace: "pre-wrap", overflowWrap: "break-word", border: "1px solid transparent", textAlign: "start"}}> </div>
                ...
                <div class="css-dnlyp1" >
                    <button class="css-dnlyp1">Rules</button>
                    { rules}
                        <div id="rollbit-modal-popover-container">
